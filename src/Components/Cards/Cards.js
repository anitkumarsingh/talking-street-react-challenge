...
const styles = theme => ({
  card: {
    ...
    transition:
      '0.2s box-shadow ease-in-out, 0.2s background-color ease-in-out, 0.2s border-color ease-in-out',
      ...
      <Grid container spacing={20}>
        <Grid item xs={12} lg={6} xl={6} md={6} sm={6}>
          <Card className={classes.card}>
            <CardHeader title={items[0].Title} subheader={items[0].Location} />
            ...
            <Collapse in={this.state.expanded} timeout="auto" unmountOnExit>
              <CardContent style={{ backgroundColor: '#ebebeb' }}>
                ...
                <Typography component="h6" variant="h6">
                  {items[0]['option-title']}
                </Typography>
                <Typography paragraph>{items[0].options}</Typography>
              </CardContent>
            </Collapse>
            ...
            />
            <CardContent>
              <Typography component="p">{items[0].description}</Typography>
            </CardContent>
          </Card>
        </Grid>
        <Grid item xs={12} lg={6} xl={6} md={6} sm={6}>
          <Card className={classes.card}>
            <CardContent>
              <Typography component="p">{items[1].description}</Typography>
              <hr
                style={{
                  marginTop: '30px',
                  display: 'block',
              ...
              <Typography component="h6" variant="h6" gutterBottom>
                {items[1]['option-title']}
              </Typography>
              <Typography paragraph>{items[1].options}</Typography>
              <Buttons />
            </CardContent>
          </Card>
        </Grid>
